...
<html>
    ...
    <body class="min-h-screen bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-600">
        ...
        <div class="min-h-screen flex items-center justify-center px-4 pt-16 pb-10">
            ...
            <section
            class="w-full max-w-md bg-white/95 backdrop-blur rounded-2xl shadow-xl border border-white/40 p-6 sm:p-8 space-y-6"
            >
            ...
            <!-- Form -->
            <form method="POST" action="/phps/login.php" class="space-y-5">
